    ...
    var _renderDOM = function(){
        ...
        switch (settings.type){
            ...
            case 'confirm' :
                ...
                content.append(
                    contentBd = $('<div class="dialog-content-bd"></div>')
                );
                contentBd.append(
                    bodyContainer = $('<div class="dialog-content-body">'+ settings.contentHtml +'</div>')
                );
                content.append(
                    contentFt = $('<div class="dialog-content-ft"></div>')
                );
                contentFt.append(
                    footerContainer = $('<div class="dialog-content-footer"></div>')
                );
                footerContainer.append(

                    cancelBtn = $('<a class="dialog-btn dialog-btn-ok '+ settings.buttonClass.cancel +'" href="javascript:;">'+ settings.buttonText.cancel + ' ' + '</a>'),
                    okBtn = $('<a class="dialog-btn dialog-btn-cancel '+ settings.buttonClass.ok +'" href="javascript:;">'+ settings.buttonText.ok +'</a>')
                );
                break;
            ...
            case 'info' :
                ...
                contentBd.append(
                    bodyContainer = $('<div class="dialog-content-body">'+ infoContent +'</div>')
                );
