...
class ScaleImagesService
{
    protected $images = [];
    protected $source;
    protected $mimeTypes = ['image/jpeg', 'image/jpg', 'image/JPG', 'image/png', 'image/gif', 'image/webp'];
    ...
    protected function generateOutput($image, $resource)
    {
        ...
        if ($this->useImageScale) {
            ...
            foreach ($this->outputSizes as $outputSize) {
                ...
                $filename = $nameParts['filename'] . '.' . $nameParts['extension'];
