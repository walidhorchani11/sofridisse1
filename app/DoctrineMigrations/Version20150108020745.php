 ...
 */
class Version20150108020745 extends AbstractMigration
{
        ...
        $this->addSql('
            ...
            BEGIN
                ...
                WHILE i<nb_famille DO 
                    ...
                    on duplicate key update total_price = prix * @coef;
                ...
                on duplicate key update total_price = p.prix * up.coefficient;
                ...
                inner join produit_coef_tmp tmp
                    ...
                    and pc.is_new <> tmp.is_new
                    and pc.show_promotion <> tmp.show_promotion
                    and pc.show_price <> tmp.show_price
                    and pc.show_exclusivity <> tmp.show_exclusivity
                    and pc.total_price <> tmp.total_price
